			       ...
			       const u8 key[CHACHA20POLY1305_KEYLEN])
{
	...
	__chacha20poly1305_encrypt(dst, src, src_len, ad, ad_len, get_unaligned_le64((__le64 *)(nonce + 16)), derived_key, simd_context);
			       ...
			       const u8 key[CHACHA20POLY1305_KEYLEN])
{
	...
	hchacha20(derived_key, nonce, key, simd_context);
	ret = __chacha20poly1305_decrypt(dst, src, src_len, ad, ad_len, get_unaligned_le64((__le64 *)(nonce + 16)), derived_key, simd_context);
	memzero_explicit(derived_key, CHACHA20POLY1305_KEYLEN);
	simd_put(simd_context);
	return ret;
}
