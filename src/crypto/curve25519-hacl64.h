...
static __always_inline void format_fexpand(u64 *output, const u8 *input)
{
	...
	i0 = get_unaligned_le64((__force __le64 *)input);
	i1 = get_unaligned_le64((__force __le64 *)x00);
	i2 = get_unaligned_le64((__force __le64 *)x01);
	i3 = get_unaligned_le64((__force __le64 *)x02);
	i4 = get_unaligned_le64((__force __le64 *)x0);
