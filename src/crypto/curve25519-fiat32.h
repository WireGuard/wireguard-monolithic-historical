...
static __always_inline void fe_frombytes_impl(u32 h[10], const u8 *s)
{
	...
	u32 a0 = get_unaligned_le32((__force __le32 *)(s));
	u32 a1 = get_unaligned_le32((__force __le32 *)(s+4));
	u32 a2 = get_unaligned_le32((__force __le32 *)(s+8));
	u32 a3 = get_unaligned_le32((__force __le32 *)(s+12));
	u32 a4 = get_unaligned_le32((__force __le32 *)(s+16));
	u32 a5 = get_unaligned_le32((__force __le32 *)(s+20));
	u32 a6 = get_unaligned_le32((__force __le32 *)(s+24));
	u32 a7 = get_unaligned_le32((__force __le32 *)(s+28));
